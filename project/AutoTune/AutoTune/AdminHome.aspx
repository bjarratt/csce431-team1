...
<body>
    ...
    Admin Home
        ...
        <br />
        <br />
        <asp:LinkButton ID="LinkButton3" runat="server">View Dealership List</asp:LinkButton>
        <br />
        <br />
        <asp:LinkButton ID="LinkButton4" runat="server">Messaging</asp:LinkButton>
        <br />
        <br />
        <asp:LinkButton ID="LinkButton5" runat="server">Logout</asp:LinkButton>
    </div>
    </form>
</body>
</html>
